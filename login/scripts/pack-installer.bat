...
title dnf Launcher Packaging Engine - NSIS Installer Generation
...
echo ============================================================
echo 🛠️  Verifying environment and compiling setup wizard (.exe)...
echo ============================================================
...
if %ERRORLEVEL% equ 0 (
    echo.
    echo 🎉 Success! The setup wizard wizard has been perfectly compiled into: out\package\
    dir /b "%PACKAGE_DIR%\*.exe"
) else (
    echo ❌ ERROR: CPack installation wizard deployment failed. Ensure NSIS is installed.
)
